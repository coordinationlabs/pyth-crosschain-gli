...
abigen!(
    PythRandom,
    "../../project-source/target_chains/ethereum/entropy_sdk/solidity/abis/IEntropy.json";
    PythRandomErrors,
    "../../project-source/target_chains/ethereum/entropy_sdk/solidity/abis/EntropyErrors.json"
);
